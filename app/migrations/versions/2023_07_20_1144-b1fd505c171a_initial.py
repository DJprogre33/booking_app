...
Revision ID: b1fd505c171a
Revises: 
Create Date: 2023-07-20 11:44:06.317107
...
def upgrade() -> None:
    ...
    sa.Column('role', postgresql.ENUM('user', 'hotel owner', 'admin', name='role'), nullable=True),
    sa.PrimaryKeyConstraint('id')
    )
